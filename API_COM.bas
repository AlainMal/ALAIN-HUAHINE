Attribute VB_Name = "API_COM"
Option Explicit

'********************************************************************************
'Ce programme fonctionne bien, il est modifier pour fonctionner en 64 bits
'
'Merci à,l'éditeur que vous voyez ci-dessous pour avoir réalisé ce programme.
'********************************************************************************

'-------------------------------------------------------------------------------
' modCOMM - Written by: David M. Hitchner
'    * with very slight modification by H. Evensen
'
...
' Port ID.    ** Evensen modified to handle 6 serial ports.  Search for "HTE"
'              ** to find this.
'
...
'
'       ** Evensen's modification:  inserting " " to function declarations
'       **  so that Hitchner's code works with 64-bit systems.  This "fix" may
...
Private Const MAX_PORTS = 6  ' this was 4; HTE changed to 6
...
Dim udtCommTimeOuts As COMMTIMEOUTS
    ...
    With udtCommTimeOuts
        ...
        .ReadTotalTimeoutConstant = 1000     '.ReadTotalTimeoutConstant = 1000, valeur initial
